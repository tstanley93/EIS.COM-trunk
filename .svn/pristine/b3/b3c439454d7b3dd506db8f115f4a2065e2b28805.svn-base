...
<asp:Content ID="Content1" ContentPlaceHolderID="main_nav" runat="server">
    <div style="width:577px;">
        ...
        <p>In the "Microsoft Exchange Proxy Settings" window type "rpcmail.allmobilecs.com" in the "https://" box.  Next click to check the "Only connect to proxy servers that have this principal name in 
        their certificate:" check box.  Then in the box below type "msstd:rpcmail.allmobilecs.com".  Now cick to check the box "On slow networks, connect using HTTP first, then connect using TCP/IP" check 
